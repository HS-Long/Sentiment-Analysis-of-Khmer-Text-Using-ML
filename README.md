...
| ------------------- | ------------ | ------------ |
| Random Forest       | 0.8023    | 0.8005    |
| Logistic Regression | 0.7713    | 0.7712    |
| XGBoost             | 0.7752    | 0.7707    |
| Bidirectional LSTM  | 0.7661    | 0.7656    |
| SVM                 | 0.7339    | 0.7332    |
| Naive Bayes         | 0.5969    | 0.5832    |

_Note: Results vary with dataset size, preprocessing, and hyperparameters_
